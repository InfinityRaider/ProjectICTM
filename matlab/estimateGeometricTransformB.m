function [tform, inlier_points1, inlier_points2, status,tmatrix] ...
    = estimateGeometricTransformB(matched_points1, matched_points2, ...
...
if status == statusCode.NoError
    [isFound, tmatrix, inliers] = msac(sampleSize, maxNumTrials, ...
...
%==========================================================================
function [isFound, tform, inliers] = msac(sampleSize, maxNumTrials, ...
    confidence, threshold, points1, points2, classToUse)
